...
function Icons(props) {
  switch (props.type) {
    ...
    case "danger" :
      ...
      break;
    case "succes" :
      return <i className="fas fa-check-circle text-success mr-2 fa-2x"></i>
      break;
    default :
      return <i className="fas fa-exclamation-circle text-danger mr-2 fa-2x"></i>
  }
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            ...
            <div className="modal-footer p-2">
              <button type="button" className="btn btn-primary btn-sm" data-dismiss="modal">Entendido</button>
            </div>
          </div>
        </div>
      </div>
